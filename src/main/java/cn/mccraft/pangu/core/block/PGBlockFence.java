...
public class PGBlockFence extends PGBlock {
...
//        if (block instanceof BlockFence || block instanceof PGBlockFence)
//            return block.getMaterial(iblockstate)==blockMaterial;
        if (block == this)
            return true;

        if (block instanceof BlockFenceGate || block instanceof PGBlockFenceGate)
            return true;
        ...
        return false;
//        return (!(block instanceof BlockFence || block instanceof PGBlockFence) || block.getMaterial(iblockstate) != this.blockMaterial) && !(block instanceof BlockFenceGate || block instanceof PGBlockFenceGate) ?
...
//        return connector instanceof BlockFence || connector instanceof PGBlockFence;
