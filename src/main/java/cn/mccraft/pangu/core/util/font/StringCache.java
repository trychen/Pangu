...
public class StringCache {
     ...
     */
    WeakHashMap<Key, Entry> stringCache = new WeakHashMap();
    /**
     ...
     */
    WeakHashMap<String, Key> weakRefCache = new WeakHashMap();
    /**
     ...
     * all visible strings will be immediately re-layed out using the new font selection.
     *
     * @param fontName  the new font
     * @param fontSize  the new point size
     * @param antiAlias turn on anti aliasing
     */
    public void setDefaultFont(String fontName, int fontSize, boolean antiAlias) {
        setDefaultFont(new Font(fontName, Font.PLAIN, 72), fontSize, antiAlias);
    }
     ...
     * all visible strings will be immediately re-layed out using the new font selection.
     *
     * @param fontFile  the new font
     * @param fontSize  the new point size
     * @param antiAlias turn on anti aliasing
     */
    public void setDefaultFont(File fontFile, int fontSize, boolean antiAlias) {
        try {
